...
export default function IntroOverlay() {
  ...
  return (
    <div className={`fixed inset-0 z-[100] flex items-center justify-center bg-black transition-opacity duration-[1500ms] ${fade ? "opacity-0 pointer-events-none" : "opacity-100"}`}>
      ...
      <div className="relative z-10 text-center flex flex-col items-center px-4">
        <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-white tracking-widest uppercase animate-in zoom-in duration-1000 delay-300 fill-mode-both">
          Timeles <span className="text-[#B8860B] italic">Art</span>
        </h1>
        <div className="w-24 h-px bg-[#B8860B] my-6 animate-in fade-in duration-1000 delay-700 fill-mode-both"></div>
